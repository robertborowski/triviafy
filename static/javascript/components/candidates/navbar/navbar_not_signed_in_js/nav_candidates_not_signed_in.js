      ...
      <ul>
        <li class="navbar-list-item-a"><a href="#">Resources <i class="fas fa-angle-down navbar-drop-down-arrow-a"></i></a>
          ...
          <ul class="links-level-2 default-box-shadow-grey-reg">
            <li><a href="${this.getAttribute("redirect_candidates_about_page")}">About</a></li>
            <li><a href="#">FAQ</a></li>
        ...
        <div class="navbar-not-signed-in-demo-button-section-3">
          <a href="#"><button class="default-button-format default-button-format-primary-color navbar-not-signed-in-button-position-3">Try for free!</button></a>
        </div>
      </ul>
    </div>
