...
def transpose_slack_user_data_to_nested_dict_function(user_uuid, user_datetime_account_created, user_first_name, user_last_name, user_display_name, user_email, user_slack_authed_id, user_slack_workspace_team_id, user_slack_workspace_team_name, user_slack_channel_id, user_slack_channel_name, user_company_name, user_slack_bot_user_id, user_is_payment_admin_teamid_channelid,  user_slack_token_type, user_slack_access_token, user_slack_timezone, user_slack_timezone_label, user_slack_timezone_offset, user_slack_job_title, user_slack_email_permission_granted, user_slack_team_channel_incoming_webhook_url, user_slack_new_user_questionnaire_answered, user_slack_new_user_categories_selected):
  ...
  user_dict = {
    'user_uuid' : user_uuid,
    'user_account_created_timestamp' : user_datetime_account_created,
    'user_first_name' : user_first_name,
    'user_last_name' : user_last_name,
    'user_full_name' : user_display_name,
    'user_email' : user_email,
    'slack_user_id' : user_slack_authed_id,
    'slack_team_id' : user_slack_workspace_team_id,
    'slack_team_name' : user_slack_workspace_team_name,
    'slack_channel_id' : user_slack_channel_id,
    'slack_channel_name' : user_slack_channel_name,
    'user_company_name' : user_company_name,
    'slack_bot_user_id' : user_slack_bot_user_id,
    'user_is_payment_admin' : user_is_payment_admin_teamid_channelid,
    'slack_token_type' : user_slack_token_type,
    'slack_access_token' : user_slack_access_token,
    'slack_timezone' : user_slack_timezone,
    'slack_timezone_label' : user_slack_timezone_label,
    'slack_timezone_offset' : user_slack_timezone_offset,
    'slack_user_job_title' : user_slack_job_title,
    'user_slack_email_permission_granted' : user_slack_email_permission_granted,
    'slack_authed_webhook_url' : user_slack_team_channel_incoming_webhook_url,
