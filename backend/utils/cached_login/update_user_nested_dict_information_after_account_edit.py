...
def update_user_nested_dict_information_after_account_edit_function(postgres_connection, postgres_cursor, slack_workspace_team_id, slack_channel_id, user_uuid):
  ...
  user_dict = {
    ...
    'user_datetime_account_created' : str(pulled_user_arr[1]),
    'user_first_name' : pulled_user_arr[2],
    'user_last_name' : pulled_user_arr[3],
    'user_display_name' : pulled_user_arr[4],
    'user_email' : pulled_user_arr[6],
    'user_slack_authed_id' : pulled_user_arr[7],
    'user_slack_workspace_team_id' : pulled_user_arr[8],
    'user_slack_workspace_team_name' : pulled_user_arr[9],
    'user_slack_channel_id' : pulled_user_arr[10],
    'user_slack_channel_name' : pulled_user_arr[11],
    'user_company_name' : pulled_user_arr[12],
    'user_slack_bot_user_id' : pulled_user_arr[13],
    'user_is_payment_admin_teamid_channelid' : pulled_user_arr[14],
    'user_slack_token_type' : pulled_user_arr[15],
    'user_slack_access_token' : pulled_user_arr[16],
    'user_slack_timezone' : pulled_user_arr[17],
    'user_slack_timezone_label' : pulled_user_arr[18],
    'user_slack_timezone_offset' : pulled_user_arr[19],
    'user_slack_job_title' : pulled_user_arr[20],
    'user_slack_email_permission_granted' : pulled_user_arr[21],
    'user_slack_team_channel_incoming_webhook_url' : pulled_user_arr[22],
