...
# -------------------------------------------------------------- App Setup
collect_email_confirm_page_render_template = Blueprint("collect_email_confirm_page_render_template", __name__, static_folder="static", template_folder="templates")
@collect_email_confirm_page_render_template.before_request
def before_request():
