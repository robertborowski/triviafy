...
# -------------------------------------------------------------- App Setup
candidates_faq_page_render_template = Blueprint("candidates_faq_page_render_template", __name__, static_folder="static", template_folder="templates")
@candidates_faq_page_render_template.before_request
def before_request():
