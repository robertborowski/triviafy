...
# -------------------------------------------------------------- App Setup
launch_page_render_template = Blueprint("launch_page_render_template", __name__, static_folder="static", template_folder="templates")
@launch_page_render_template.before_request
def before_request():
