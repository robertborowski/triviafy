...
# -------------------------------------------------------------- App Setup
login_success_page_render_template = Blueprint("login_success_page_render_template", __name__, static_folder="static", template_folder="templates")
@login_success_page_render_template.before_request
def before_request():
