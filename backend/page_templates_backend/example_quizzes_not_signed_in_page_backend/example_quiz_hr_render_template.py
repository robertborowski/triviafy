...
@example_quiz_hr_render_template.before_request
def before_request():
...
# -------------------------------------------------------------- App
@example_quiz_hr_render_template.route("/example/hr", methods=['GET','POST'])
def example_quiz_hr_render_template_function():
  localhost_print_function('=========================================== /example/hr Page START ===========================================')
  ...
  quiz_questions_obj_arr_of_dicts = select_x_questions_category_hr_function(postgres_connection, postgres_cursor)
  ...
  localhost_print_function('=========================================== /example/hr Page END ===========================================')
  return render_template('employee_engagement_page_templates/example_quizzes_not_signed_in_page_templates/index_hr.html',
