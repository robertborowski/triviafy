...
def account_index_page_render_template_function():
  ...
  try:
    ...
    user_nested_dict, free_trial_ends_info = pre_load_page_checks_function('/account')
  ...
  localhost_print_function('=========================================== /account Page END ===========================================')
  return render_template('employee_engagement_page_templates/account_page_templates/index.html',
