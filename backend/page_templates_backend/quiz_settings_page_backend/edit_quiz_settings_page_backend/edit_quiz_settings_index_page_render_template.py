...
def edit_quiz_settings_index_page_render_template_function():
  ...
  try:
    ...
    user_nested_dict, free_trial_ends_info = pre_load_page_checks_function('/quiz/team/settings/payment/admin/edit')
    ...
    localhost_print_function('page load except error hit - /quiz/team/settings/payment/admin/edit Page')
    localhost_print_function('=========================================== /quiz/team/settings/payment/admin/edit Page END ===========================================')
    return redirect('/logout', code=302)
  ...
  return render_template('employee_engagement_page_templates/quiz_settings_page_templates/edit_quiz_settings_page_templates/index.html',
                          ...
                          page_title_to_html = 'Edit Quiz Settings')