...
# -------------------------------------------------------------- App Setup
blog_index_page_render_template = Blueprint("blog_index_page_render_template", __name__, static_folder="static", template_folder="templates")
@blog_index_page_render_template.before_request
def before_request():
