class NavbarClass extends HTMLElement {  
  ...
  connectedCallback() {
    this.innerHTML = `
    <nav class="navbar-signed-in default-box-shadow-grey-reg">
      <div class="company-name-and-logo">
        <a href="${this.getAttribute("link_home_js")}"><img src="/static/images/employee_engagement/logo/Logo.png" class="company-logo" alt="Triviafy icon/logo"></a>
      ...
      <div class="navbar-links">
        <ul>
          ...
          <li class="drill-down"><a href="#">Quiz <i class="fas fa-caret-down"></i></a>
            <ul class="sub-list-items thicker-ul-item">
              <li><a href="${this.getAttribute("link_quiz_feedback_index_js")}">Feedback</a></li>
              <li><a href="${this.getAttribute("link_quiz_archive_js")}">Archive</a></li>
              ...
              <li><a href="${this.getAttribute("link_quiz_categories_js")}">Categories</a></li>
              <li><a href="${this.getAttribute("link_quiz_sample_js")}">Sample</a></li>
            </ul>
          </li>
