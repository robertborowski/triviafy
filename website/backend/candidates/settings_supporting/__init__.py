...
# ------------------------ individual function start ------------------------
def activity_a_settings_post_function(page_dict, url_activity_code, db_activity_settings_obj, db_activity_settings_dict, ui_start_day, ui_start_time, ui_end_day, ui_end_time, ui_timezone, ui_cadence, ui_total_questions, ui_question_type, ui_select_all_categories, ui_selected_categories):
  post_result = False
