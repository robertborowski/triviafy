...
def get_team_building_activities_list_function():
  activities_list = ['Trivia', 'Icebreakers', 'Employee surveys', 'Personality tests', 'Picture quizzes', 'Colleague birthday trivia', 'Most likely to', 'This or that', 'Watercooler starters', 'Word games', '2 player games', 'Create custom questions']
