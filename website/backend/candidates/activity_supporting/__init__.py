...
from website.backend.candidates.pull_create_logic import pull_create_activity_a_settings_obj_function, pull_latest_activity_a_test_obj_function, pull_latest_activity_a_test_graded_obj_function, pull_create_activity_b_settings_obj_function
...
# ------------------------ individual function start ------------------------
def activity_b_dashboard_function(current_user, page_dict, activity_name):
  redirect_code = None
  # ------------------------ pull/create group settings activities start ------------------------
  db_activity_settings_obj = pull_create_activity_b_settings_obj_function(current_user, activity_name)
  db_activity_settings_dict = arr_of_dict_all_columns_single_item_function(db_activity_settings_obj)
  page_dict[activity_name+'_settings_dict'] = db_activity_settings_dict
  # ------------------------ pull/create group settings activities end ------------------------
  """
