...
def job_send_schedule_email_assessment_link_function():
  ...
  for i_schedule_arr in result_schedules_arr:
    ...
    if current_datetime_datetime > db_schedule_obj_goal_timestamp:
      ...
      output_body = f"Hi there,\n\nYour Triviafy test is ready! The following link will expire 1 hour from the time you receive this email.\nPlease visit the following link to complete your test: https://triviafy.com/candidates/assessment/{i_schedule_arr_expiring_url}/1 \n\nBest,\nTriviafy"
      # output_body = f"Hi there,\n\nYour Triviafy test is ready! The following link will expire 1 hour from the time you receive this email.\nPlease visit the following link to complete your test: http://127.0.0.1/candidates/assessment/{i_schedule_arr_expiring_url}/1 \n\nBest,\nTriviafy"
